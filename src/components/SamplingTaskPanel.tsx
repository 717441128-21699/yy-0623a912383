...
export default function SamplingTaskPanel({ onDataChange }: Props) {
  ...
  const handleSubmit = async () => {
    if (!form.batch_no || !form.quantity || !form.represent_quantity || !form.sampling_location) {
      alert('请填写必填项');
      return;
    }
    ...
    <div>
      <div className="panel">
        <div className="panel-header">
          <div className="panel-title">进场批次与待取样清单</div>
            ...
            <div className="modal-body">
              ...
              <div className="form-row">
                <div className="form-item">
                  ...
                  <input type="number" value={form.quantity} onChange={e => setForm({ ...form, quantity: e.target.value })} placeholder="数值" />
                </div>
                <div className="form-item">
                  <label>炉批号（钢筋必填）</label>
                ...
                <div className="form-item">
                  ...
                  <input type="number" value={form.represent_quantity} onChange={e => setForm({ ...form, represent_quantity: e.target.value })} placeholder="取样代表数量" />
                </div>
              </div>
              <div className="form-row">
                <div className="form-item">
